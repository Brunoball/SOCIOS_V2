...
$allowed = array_values(array_filter(array_map('trim', explode(',', (string)env_value('ALLOWED_ORIGINS', '')))));
...
if (!headers_sent()) {
    ...
    header('Access-Control-Allow-Headers: Accept, Content-Type, Authorization, X-Session, X-Session-Key');
