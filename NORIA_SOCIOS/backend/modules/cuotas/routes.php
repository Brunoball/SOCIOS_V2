...
function register_cuotas_routes(Router $router): void
{
    ...
    $router->register('cuotas_registrar_pago_multiple', 'POST', [Cuotas::class, 'registrarPagoMultiple'], true);
    $router->register('cuotas_saldo_ajustar', 'POST', [Cuotas::class, 'ajustarSaldo'], true);
