    ...
    setSaleForm((current) => {
      const items = current.items.map((item, itemIndex) => {
        ...
        if (field === "id_producto") {
          ...
          // Cambiar el producto convierte la línea en una línea nueva.
          // Así el backend toma el catálogo actual en vez del snapshot histórico.
          delete next.id_item;
