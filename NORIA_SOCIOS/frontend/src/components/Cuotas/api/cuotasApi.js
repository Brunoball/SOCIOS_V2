...
export const cuotasApi = {
  ...
  registrarCobro: (payload) => apiPost("cuotas_registrar_cobro", payload),
  registrarPagoMultiple: (payload) => apiPost("cuotas_registrar_pago_multiple", payload),
  ajustarSaldo: (payload) => apiPost("cuotas_saldo_ajustar", payload),
