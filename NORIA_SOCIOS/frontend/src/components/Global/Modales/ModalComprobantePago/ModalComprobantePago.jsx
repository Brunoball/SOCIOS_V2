  ...
  return (
    ...
    >
      ...
      <div className="payment-receipt-detail">
        ...
        {receipt.montoSaldoFavorAplicado > 0 ? (
          <div>
            <span>Monto a favor aplicado</span>
            <strong>{money(receipt.montoSaldoFavorAplicado)}</strong>
          </div>
        ) : null}
        {receipt.montoSaldoFavorAplicado > 0 || receipt.sobranteSaldoFavor > 0 ? (
          <div>
            <span>Recibido ahora</span>
            <strong>{money(receipt.montoCobradoAhora)}</strong>
          </div>
        ) : null}
        {receipt.sobranteSaldoFavor > 0 ? (
          <div>
            <span>Sobrante a favor</span>
            <strong>{money(receipt.sobranteSaldoFavor)}</strong>
          </div>
        ) : null}
      </div>
